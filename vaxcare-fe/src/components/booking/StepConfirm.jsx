    ...
    <div className={`book-step${active ? ' active' : ''}`} data-step="4">
      ...
      <div className="book-panel-body">
        <div id="confirmView" style={{ display: success ? 'none' : undefined }}>
          ...
          >
            Kiểm tra lại thông tin trước khi xác nhận đặt lịch. Bạn sẽ nhận mã QR check-in qua hệ
            thống.
          </p>
          <label
            style={{
        ...
        <div id="successView" style={{ display: success ? 'block' : 'none' }}>
          <div className="success-box">
            ...
            {bookingCode && (
              <p style={{ fontSize: '13px', color: 'var(--gray-600)', marginTop: '12px' }}>
                Mã đặt lịch: <strong>{bookingCode}</strong>
              </p>
            )}
            <div
              style={{
