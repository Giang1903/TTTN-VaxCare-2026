// ============ WHY AGAIN ============
export default function WhyChooseVaxCare() {
  return (
    <section className="why" style={{ padding: '80px 0' }}>
      <div className="wrap">
        <div className="section-head center">
          <span className="eyebrow">
            <span className="dot"></span>Vì sao chọn VaxCare
          </span>
          <h2>Công nghệ phục vụ sức khỏe</h2>
          <p>Kết hợp AI, dữ liệu thời gian thực và quy trình y tế chuẩn.</p>
        </div>
        <div className="why-grid" style={{ marginTop: '48px' }}>
          ...
          <div className="card why-card">
            ...
            <p>Rút ngắn thời gian chờ tại cơ sở nhờ quy trình xác thực nhanh.</p>
          </div>
          <div className="card why-card">
            <div className="why-icon">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
